			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lkmrmajax-display": {
								"semanticObject": "lkmrmajax",
								"action": "display",
								"description": "Teste Ajax",
								"title": "testeajax",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lkm.rm.ajax",
									"url": sap.ui.require.toUrl("lkm/rm/ajax")
								}
							}
						}
					}
